...
public:
    constexpr explicit FireworkRocketDealDamageBeforeEvent(FireworksRocketActor& actor) : Cancellable(actor) {}
...
public:
    constexpr explicit FireworkRocketDealDamageAfterEvent(FireworksRocketActor& actor) : ActorEvent(actor) {}
