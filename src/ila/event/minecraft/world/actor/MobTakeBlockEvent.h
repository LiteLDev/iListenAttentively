...
public:
    constexpr explicit MobTakeBlockBeforeEvent(Mob& mob, BlockPos& pos) : Cancellable(mob), mPos(pos) {}
...
public:
    constexpr explicit MobTakeBlockAfterEvent(Mob& mob, BlockPos& pos) : MobEvent(mob), mPos(pos) {}
