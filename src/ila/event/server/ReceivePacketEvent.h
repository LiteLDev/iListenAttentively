...
public:
    constexpr explicit ReceivePacketBeforeEvent(PacketType& packet, NetworkIdentifier const& networkIdentifier)
...
public:
    constexpr explicit IReceivePacketAfterEvent(Packet const& packet, NetworkIdentifier const& networkIdentifier)
    : mPacket(packet),
      mNetworkIdentifier(networkIdentifier) {}
...
public:
    constexpr explicit ReceivePacketAfterEvent(PacketType const& packet, NetworkIdentifier const& networkIdentifier)
    : IReceivePacketAfterEvent(packet, networkIdentifier) {}

    PacketType const& packet() const { return static_cast<PacketType const&>(IReceivePacketAfterEvent::packet()); }
};
