...
void PlayerChangeDimensionBeforeEvent::serialize(CompoundTag& nbt) const {
    ...
    nbt["fromLocation"]    = ListTag{
        changeDimensionRequest().mFromLocation->x,
        changeDimensionRequest().mFromLocation->y,
        changeDimensionRequest().mFromLocation->z
    };
    nbt["toLocation"] = ListTag{
        changeDimensionRequest().mToLocation->x,
    ...
    if (changeDimensionRequest().mAgentTag) {
        nbt["agentTag"] = *changeDimensionRequest().mAgentTag;
    }
}
